...
// WiFi settings
const char* ssid     = "Silavadee_2G";
const char* password = "0809000240";

// VPN settings
char* broker = "vpn.osszone.com";
char* broker_user = "ossuser1";
char* broker_password = "osspwd1";
...
// struct mqtt_if_data *mqtt_if_init(broker, vpn_user, vpn_password, mqtt_vpn_addr);

struct mqtt_if_data *my_if ;

my_if = mqtt_if_init(broker,broker_user,broker_password, mqtt_vpn_addr, vpn_password ) ;
  server.begin();
